...
###  **4  Create sample pods and verify the configuration**  **4.1  Launch Test Pods**
...
The sharp drop confirms that `NetworkQoS` is enforcing the **20 Mbit/s** policer only for pods matching the selector.
