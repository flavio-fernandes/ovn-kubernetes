...
#OVN_SECONDARY_CNI_ENABLE - enable ovn-kubernetes as a secondary CNI
...
ovn-master() {
  ...
  secondary_cni_enabled_flag=
  if [[ ${ovn_secondary_cni_enable} == "true" ]]; then
	  secondary_cni_enabled_flag="--secondary-cni"
  fi
  echo "secondary_cni_enabled_flag=${secondary_cni_enabled_flag}"
